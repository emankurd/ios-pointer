...
class Profetional_dress6 extends StatefulWidget {
  const Profetional_dress6({Key? key}) : super(key: key);

  @override
  _Profetional_dress6State createState() => _Profetional_dress6State();
}

class _Profetional_dress6State extends State<Profetional_dress6> {
              ...
              child: Column(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text_widget(textAlign: TextAlign.start, text: getTranslated(context, 'prof_sec6_text1')!, text_size: 18),
                      SizedBox(height: 10.h,),
                      Row(
                        children: [
                          AppWidgetElevatedButton(height_size: 40.h, width_size: 120.w,  text: getTranslated(context, 'prof_sec6_text2')!, onpressed: (){},
                            background_color: AppColors.GrAY_Light_Back_COLOR,
                            color_text: Colors.black,border_size: 15.r,fontSize: 14.sp,
                          ),
                          SizedBox(width: 10.w,),
                          AppWidgetElevatedButton(height_size: 40.h,width_size: 120.w,  text: getTranslated(context, 'prof_sec6_text3')!, onpressed: (){},
                            background_color: AppColors.GrAY_Light_Back_COLOR,
                            color_text: Colors.black,border_size: 15.r,fontSize: 14.sp,
                          ),
                        ],
                        ...
                        children: [
                          Row(
                            children: [
                              SizedBox(width: 20.w,),
                              Expanded(
                                child: AppWidgetElevatedButton(height_size: 40.h,width_size:120.w,  text: getTranslated(context, 'prof_sec6_text4')!, onpressed: (){},
                                  background_color: AppColors.GrAY_Light_Back_COLOR,
                                  color_text: Colors.black,border_size: 15.r,fontSize: 14.sp,
                                ),
                              ),
                              SizedBox(width: 10.w,),
                              Expanded(
                                child: AppWidgetElevatedButton(height_size: 40.h,width_size:120.w, text:getTranslated(context, 'prof_sec6_text5')!, onpressed: (){},
                                  background_color: AppColors.GrAY_Light_Back_COLOR,
                                  color_text: Colors.black,border_size: 15.r,fontSize: 14.sp,
                                ),
                              ),
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10.w,),
                              Expanded(
                                child: AppWidgetElevatedButton(height_size: 40.h, width_size:120.w, text: getTranslated(context, 'prof_sec6_text6')!, onpressed: (){},
                                  background_color: AppColors.GrAY_Light_Back_COLOR,
                                  color_text: Colors.black,border_size: 15.r,fontSize: 14.sp,
                                ),
                              ),
                  ...
                  SizedBox(
                    ...
                    child: ListTile(
                      onTap: (){
                        Navigator.pushNamed(context, '/prof_dress7');
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: Text_widget(textAlign: TextAlign.start,text_size: 8.sp, text: getTranslated(context, 'prof_sec6_text7')!,),
                      )),
                  Center(child: AppPrefController().languageCode == 'en' ? Image.asset('images/group6.png'): Image.asset('images/group8.png') ),
